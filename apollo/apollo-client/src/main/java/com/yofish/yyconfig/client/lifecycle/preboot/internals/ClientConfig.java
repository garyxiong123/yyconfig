...
import com.yofish.yyconfig.common.framework.apollo.core.enums.EnvUtils;
...
import static com.yofish.yyconfig.common.framework.apollo.core.ConfigConsts.CONFIG_SERVER_URL;
...
public class ClientConfig implements EnvironmentAware {
    ...
    public String getConfigServerUrl() {
        ...
        configServerUrl = EnvironmentContext.environment.getProperty(CONFIG_SERVER_URL);
