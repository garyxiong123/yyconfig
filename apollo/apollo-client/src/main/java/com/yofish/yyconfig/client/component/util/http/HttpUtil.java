...
import com.yofish.yyconfig.client.component.exceptions.ApolloConfigStatusCodeException;
...
public class HttpUtil {
    @Autowired
    private ClientConfig m_Client_config = ApolloInjector.getInstance(ClientConfig.class);
    private Gson gson;
