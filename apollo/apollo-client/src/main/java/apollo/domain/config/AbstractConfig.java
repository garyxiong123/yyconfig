...
import apollo.component.util.function.Functions;
import apollo.component.util.parser.Parsers;
...
public abstract class AbstractConfig implements Config {
    ...
    private <T> Cache<String, T> newCache() {
        Cache<String, T> cache = CacheBuilder.newBuilder()
                .maximumSize(m_Client_config.getMaxConfigCacheSize())
                .expireAfterAccess(m_Client_config.getConfigCacheExpireTime(), m_Client_config.getConfigCacheExpireTimeUnit())
                .build();
        allCaches.add(cache);
        return cache;
    }
