...
import  apollo.spring.XmlConfigPlaceholderTest.TestXmlBean;
...
public class XmlConfigPlaceholderAutoUpdateTest extends AbstractSpringIntegrationTest {
  ...
  public void testAutoUpdateWithOneNamespace() throws Exception {
    ...
    XmlConfigPlaceholderTest.TestXmlBean bean = context.getBean(XmlConfigPlaceholderTest.TestXmlBean.class);
  ...
  public void testAutoUpdateWithDeletedProperties() throws Exception {
    ...
    XmlConfigPlaceholderTest.TestXmlBean bean = context.getBean(TestXmlBean.class);
