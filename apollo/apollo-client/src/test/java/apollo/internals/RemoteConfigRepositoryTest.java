...
public class RemoteConfigRepositoryTest {
  ...
  public void testLongPollingRefresh() throws Exception {
    ...
    }).when(someListener).onRepositoryChange(Matchers.any(String.class), Matchers.any(Properties.class));
  ...
  public void testAssembleQueryConfigUrl() throws Exception {
    ...
    String queryConfigUrl = remoteConfigRepository
        .assembleQueryConfigUrl(someUri, someAppId, someCluster, someNamespace, null, null,notificationMessages,
            someApolloConfig);
