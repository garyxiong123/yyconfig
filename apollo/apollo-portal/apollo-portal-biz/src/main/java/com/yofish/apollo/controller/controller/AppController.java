...
import com.ctrip.framework.apollo.listener.AppCreationEvent;
import com.ctrip.framework.apollo.listener.AppDeletionEvent;
import com.ctrip.framework.apollo.listener.AppInfoChangedEvent;
import com.ctrip.framework.apollo.model.AppModel;
import com.ctrip.framework.apollo.model.entity.Role;
import com.ctrip.framework.apollo.model.vo.EnvClusterInfo;
...
public class AppController {
  ...
  @RequestMapping(value = "/envs/{env}", method = RequestMethod.POST, consumes = {
      "application/json"}Ω)
  public <Void> create(@PathVariable String env, @RequestBody App app) {
