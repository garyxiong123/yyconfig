...
//        "{baseurl}/notifications?appCode={appCode}&cluster={clusterName}&appNamespace={appNamespace}",
...
//    ResponseEntity<ApolloConfigNotification> result = restTemplate.getForEntity(
//        "{baseurl}/notifications?appCode={appCode}&cluster={clusterName}&appNamespace={appNamespace}&notificationId={notificationId}",
//        ApolloConfigNotification.class,
...
//    ResponseEntity<ApolloConfigNotification> result = restTemplate
//        .getForEntity(
//            "{baseurl}/notifications?appCode={appCode}&cluster={clusterName}&appNamespace={appNamespace}&dataCenter={dataCenter}",
//            ApolloConfigNotification.class,
