...
import framework.foundation.internals.provider.DefaultApplicationProvider;
import framework.foundation.internals.provider.DefaultNetworkProvider;
import framework.foundation.internals.provider.DefaultServerProvider;
